...
public class RecyclerViewBannerNormal extends RecyclerViewBannerBase<LinearLayoutManager, polardreams.de.happydrink.adapter.NormalRecyclerAdapter> {
    ...
    @Override
    protected polardreams.de.happydrink.adapter.NormalRecyclerAdapter getAdapter(Context context, List<String> list, OnBannerItemClickListener onBannerItemClickListener) {
        return new polardreams.de.happydrink.adapter.NormalRecyclerAdapter(context, list,onBannerItemClickListener);
    }
